...
def create_book(db: Session, data: BookCreate, title: str | None, description: str | None) -> Book:
    book = Book(url=str(data.url), title=title, description=description)  # Create Book instance
